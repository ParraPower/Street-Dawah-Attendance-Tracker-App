...
export function buildSessionOccurrenceController(dataSource: DataSource): SessionOccurrenceController {
  ...
  return new SessionOccurrenceController(
    scopeService,
    new CreateSessionOccurrenceUseCase(repository, service),
    new GetSessionOccurrenceUseCase(repository),
    new GetSessionOccurrencesUseCase(repository),
    new UpdateSessionOccurrenceUseCase(repository, service),
